...
export default function LogoCloud() {
  return (
    <section className="overflow-hidden sm:py-16 py-4">
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="relative py-6 md:w-[calc(100%-11rem)]">
            <InfiniteSlider speedOnHover={20} speed={40} gap={112}>
              <div className="flex">
                <Image
                  className="mx-auto object-contain h-14 w-14 sm:h-10 sm:w-10 md:h-[60px] md:w-[60px]"
              ...
              <div className="flex">
                <Image
                  className="mx-auto object-contain h-16 w-16 sm:h-11 sm:w-11 md:h-[70px] md:w-[70px]"
