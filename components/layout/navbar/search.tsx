...
export default function Search() {
  ...
  return (
    <>
      <Form
        action={`/products`}
        className="p-5 overflow-hidden w-[60px] h-[58px] hover:w-[270px] shadow-[2px_2px_20px_rgba(0,0,0,0.08)] rounded-full flex group items-center hover:duration-300 duration-300"
      >
