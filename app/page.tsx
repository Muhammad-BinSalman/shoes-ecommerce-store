...
import PremiumFormalShoesCollection from "@/components/premium-formal-shoes-collection";
import RamadanDonationSection from "@/components/ramadan-donation-section";
...
export default async function HomePage() {
  // Fetch products for the hero carousel section
  ...
  return (
    <>
      ...
      <LogoCloud />
      <SeasonSale viewMoreHref="/products" />
      <ConverseCtaSection />
      <VideoBannerSection />
      <PremiumFormalShoesCollection />
      <NewSportsSection />
      <Testimonials />
