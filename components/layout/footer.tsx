  ...
  return (
    <footer className="text-sm text-neutral-500">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 border-t border-neutral-200 px-6 py-12 text-sm md:flex-row md:gap-12 md:px-4 min-[1320px]:px-0">
        ...
        <div className="md:ml-auto h-full flex flex-col justify-center items-end gap-12">
          <a
          ...
          >
            ...
            <span className="px-2">Made In Next.js</span>
          </a>
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <Link
              ...
              className="text-[#313e44] hover:text-primary block"
            >
              <svg
                className="size-6"
            ...
            <Link
              href="https://www.instagram.com/thumbthrift.pk/"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-1 px-4 md:flex-row md:gap-0 md:px-4 min-[1320px]:px-0">
          ...
          <p className="md:ml-auto">
            <a href="https://vercel.com" className="text-black">
              Created by <span className="underline">Mysh Innovation Labs</span>
            </a>
          </p>
        </div>
      </div>
